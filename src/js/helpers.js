module.exports = function(lib, xelib) {
    ...
    helpers.buildOptions = function(args, startIndex, defaults) {
        let firstArg = args[startIndex],
            isObject = typeof firstArg === 'object';
        return Object.keys(defaults).reduce((obj, key, index) => {
            obj[key] = (isObject ?
                firstArg[key] :
