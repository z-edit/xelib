module.exports = function(lib, xelib, helpers, types) {
    let { elementContext, Fail, flagContext, GetNativeValue, GetBool, GetString,
        GetDictionary, GetStringValue, SetNativeValue, wcb } = helpers,
        { PInteger, PCardinal, PDouble } = types;
    ...
    Object.assign(xelib, {
        ...
        GetIntValue: function(id, path = '') {
            return GetNativeValue(id, path, 'GetIntValue', 4, PInteger).readInt32LE();
        },
        GetIntValueEx: function(id, path = '') {
            return GetNativeValueEx(id, path, 'GetIntValue', 4, PInteger).readInt32LE();
        },
        SetIntValue: function(id, path, value) {
            SetNativeValue(id, path, 'SetIntValue', value);
        },
        GetUIntValue: function(id, path = '') {
            return GetNativeValue(id, path, 'GetUIntValue', 4, PCardinal).readUInt32LE();
        },
        GetUIntValueEx: function(_id, path = '') {
            return GetNativeValueEx(_id, path, 'GetUIntValue', 4, PCardinal).readUInt32LE();
        },
        SetUIntValue: function(id, path, value) {
            SetNativeValue(id, path, 'SetUIntValue', value);
        },
        GetFloatValue: function(id, path = '') {
            return GetNativeValue(id, path, 'GetFloatValue', 8, PDouble).readDoubleLE();
        },
        GetFloatValueEx: function(id, path = '') {
            return GetNativeValueEx(id, path, 'GetFloatValue', 8, PDouble).readDoubleLE();
        },
