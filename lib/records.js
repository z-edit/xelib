module.exports = function(lib, xelib, helpers) {
    ...
    Object.assign(xelib, {
        ...
        GetInjectionTarget: function(id) {
            return GetHandle(function(_res) {
                if (!lib.GetInjectionTarget(id, _res))
                    Fail(() => `Failed to get injection target for: ${elementContext(id)}`);
            });
        },
        ...
        GetRecordDef: function(sig) {
            return GetHandle(function(_res) {
                if (!lib.GetRecordDef(wcb(sig), _res))
                    Fail(() => `Failed to get record def for ${sig}`);
            });
        },
